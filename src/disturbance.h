...
typedef unsigned int AffordanceIndex; 
enum InnateAffordances {NONE, AVOID, PURSUE}; 
enum Direction{LEFT, RIGHT, DEFAULT, STOP, UNDEFINED};
...
class BodyFeatures{
   ...
   // b2Transform pose_local=pose;
    float halfLength=DEFAULT_DISTURBANCE_DIMENSION; //x
    float halfWidth=DEFAULT_DISTURBANCE_DIMENSION; //y
    float shift=0.0f;
